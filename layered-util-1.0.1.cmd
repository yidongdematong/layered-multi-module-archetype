...
:: 1.0.1 新增应用启动类默认值
set DEFAULT_APPLICATION_CLASS_NAME=DemoApplication
...
if "!MODE!"=="1" (
    ...
    echo 启动类名：!DEFAULT_APPLICATION_CLASS_NAME!
    ...
    set "APPLICATION_CLASS_NAME=!DEFAULT_APPLICATION_CLASS_NAME!"
) else (
    echo.
    ...
    set /p "APPLICATION_CLASS_NAME=启动类名（默认：!DEFAULT_APPLICATION_CLASS_NAME!）："
    if "!APPLICATION_CLASS_NAME!"=="" set "APPLICATION_CLASS_NAME=!DEFAULT_APPLICATION_CLASS_NAME!"
